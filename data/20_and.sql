...
select * from student where marks >80 and status ="active";

select * from student where department = 'Computer Science'  and marks > 70  and status ="active";

select first_name ,marks,status from student where marks >80 and status ="active";
...
select * from student where department = 'Computer Science'  and marks > 70  or status ="active";
select * from student where department = 'Computer Science'  and ( marks > 70  or status ="active");
